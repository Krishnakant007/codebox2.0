...
const DATA = [
  ...
  },
  {
    ...
    "exercises": [
      {"name": "Mind vs Body", "slug": "mind-vs-body", "xp": 29, "difficulty": "easy"},
      {"name": "Activate Styles", "slug": "activateStyles", "xp": 30, "difficulty": "medium"},
  ...
  },
  {
    ...
    "exercises": [
      {"name": "Create a Warp Gate", "slug": "create-a-warp-gate", "xp": 28, "difficulty": "easy"},
      {"name": "Open a New Dimension", "slug": "open-a-new-dimension", "xp": 25, "difficulty": "easy"},
      {"name": "Navigation Builder", "slug": "navigation-builder", "xp": 46, "difficulty": "medium"},
      {"name": "Anchor Teleport", "slug": "anchor-teleport", "xp": 28, "difficulty": "easy"},
      {"name": "Email Portal", "slug": "email-portal", "xp": 28, "difficulty": "easy"},
  ...
  },
  {
    ...
    "exercises": [
      {"name": "Summon an Image", "slug": "summon-an-image", "xp": 28, "difficulty": "easy"},
  ...
  },
  {
    ...
    "exercises": [
      ...
      {"name": "Placeholder Magic", "slug": "placeholder-magic", "xp": 18, "difficulty": "easy"},
      {"name": "Label Linker", "slug": "Label-Linker", "xp": 28, "difficulty": "easy"},
      {"name": "Choose Wisely", "slug": "choose-wisely", "xp": 26, "difficulty": "easy"},
      {"name": "Dropdown Selector", "slug": "dropdown-selector", "xp": 38, "difficulty": "medium"}
    ]
  },
  {
    "id": 10,
    ...
    "exercises": [
      ...
      {"name": "Blog Structure", "slug": "blog-structure", "xp": 46, "difficulty": "medium"},
      ...
      {"name": "Semantic Rebuild", "slug": "semantic-rebuild", "xp": 48, "difficulty": "medium"}
    ]
  },
  {
    "id": 11,
  ...
  },
  {
    ...
    "desc": "Write clear, clean, and accessible HTML outlines for real-world use.",
    "exercises": [
